...
#            'population':'19mil',
#            'economy':{'industry':['CompanyA', 'CompanyB'],
#                       'agriculture': {'wheat':['CompanyC', 'CompanyD'], 'corn':['CompanyE']}}}
#
# print(country['economy']['agriculture'])
